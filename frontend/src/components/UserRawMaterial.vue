<template>
    ...
    <div class="container">
      <div class="table">
        ...
        <div class="row" v-for="rawMaterial in rawMaterials" :key="rawMaterial.id">
...
export default {
    ...
    methods: {
        ...
        editRawMaterial(id) {
            ...
            var rawMaterialUpdate = this.rawMaterials.find((rawMaterial) => rawMaterial.id === id);
        ...
        updateRawMaterial() {
            ...
            if (this.name != "") {
                ...
                RawMaterialDataService.put(localStorage.getItem("rawMaterialId"), this.name)
                .then(() => {
                    // clear the field
                    this.name = "";
                    // add success message
