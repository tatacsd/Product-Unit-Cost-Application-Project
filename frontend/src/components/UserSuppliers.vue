        ...
        <div class="container">
            <div class="table">
                ...
                <div class="row" v-for="supplier in suppliers" :key="supplier.id">
                    ...
                    <div class="cell">
                        <p class="delete-btn">
                            <input type="button" v-on:delete="deleteSupplier(supplier.supplierID)">
                            <img src="../../public/images/deleteRed.png" alt="delete" width="20" height="20">
                        </p>
                        <p class="edit-btn">
                            <input type="button" v-on:click="editSupplier(supplier.supplierID)">
                ...
                <div class="row" >
                    ...
                    <div class="cell"><p><input type="text" v-model="firstName" placeholder="First Name" required></p></div>
                    <div class="cell"><p><input type="text" v-model="lastName" placeholder="Last Name" required></p></div>
                    <div class="cell"><p><input type="text" v-model="phone" placeholder="Phone" required></p></div>
                    <div class="cell"><p><input type="text" v-model="email" placeholder="Email" required></p></div>
                    <div class="cell"><p><input type="text" v-model="address" placeholder="Address" required></p></div>
...
export default {
    ...
    methods:{
        ...
        editSupplier(id){
            ...
            https.put('/suppliers/' + id, supplier)
            .then(response => {
                console.log(response);
            })
            .catch(error => {
