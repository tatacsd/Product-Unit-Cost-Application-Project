<template>
    <div>
        ...
        <div id="invoiceDetails">
            <form>
                <label># <input type="text" placeholder="Invoice Number" required></label>
                <label>Supplier # <input type="text" placeholder="Supplier Number" required></label>
                <label>Date <input type="text" placeholder="Invoice Date" required></label>
                <label>Total Value <input type="text" placeholder="Total Value" required></label>
                <input id="submitBtn" type="button" value="Submit" disabled>
            </form>
        </div>
        <div class="container">
        <div class="table">
